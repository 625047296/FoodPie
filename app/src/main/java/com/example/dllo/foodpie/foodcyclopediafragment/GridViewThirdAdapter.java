 ...
 */
public class GridViewThirdAdapter extends BaseAdapter{
    Context mContext;

    public GridViewThirdAdapter(Context mContext) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_food_gridviewthree,parent,false);
    ...
    private class MyyViewHolder {
        ...
        public MyyViewHolder(View convertView) {
            imageView = (ImageView) convertView.findViewById(R.id.iv_gridviewthreeitem);
            textView = (TextView) convertView.findViewById(R.id.tv_gridviewthreeitem);
        }
    }
}
